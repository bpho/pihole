...
This repo documents and tracks my Raspberry Pi Zero W Pi-hole setup.

## Preferences

- Keep documentation beginner-friendly, practical, and easy to follow.
- Use Markdown checklists for setup steps when they make progress easier to track.
...
- Default branch: `main`
- Remote: `https://github.com/bpho/pihole.git`
